...
class MelodyClefRenderer extends BaseMelodyRenderer {
  ...
  draw(Canvas canvas) {
    ...
    clefs.forEach((clef) {
      ...
      switch(clef) {
        case Clef.treble:
          canvas.translate(0.2 * bounds.width, 33.2 * halfStepPhysicalDistance); // Position of clef
          canvas.scale(0.0092 * halfStepPhysicalDistance);
          canvas.drawPath(_trebleClefPath, alphaDrawerPaint);
          break;
        case Clef.bass:
          canvas.translate(0.2 * bounds.width, 51.75 * halfStepPhysicalDistance); // Position of clef
