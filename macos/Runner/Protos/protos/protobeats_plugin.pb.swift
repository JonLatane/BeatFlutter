...
struct RecordedSegment {
  ...
  var beats: [RecordedSegment.RecordedBeat] = []

  var recordedData: [RecordedSegment.RecordedData] = []
...
extension RecordedSegment: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = "RecordedSegment"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "beats"),
    2: .standard(proto: "recorded_data"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      // enabled. https://github.com/apple/swift-protobuf/issues/1034
      switch fieldNumber {
      case 1: try { try decoder.decodeRepeatedMessageField(value: &self.beats) }()
      case 2: try { try decoder.decodeRepeatedMessageField(value: &self.recordedData) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.beats.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.beats, fieldNumber: 1)
    }
    if !self.recordedData.isEmpty {
      try visitor.visitRepeatedMessageField(value: self.recordedData, fieldNumber: 2)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: RecordedSegment, rhs: RecordedSegment) -> Bool {
    if lhs.beats != rhs.beats {return false}
    if lhs.recordedData != rhs.recordedData {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension RecordedSegment.RecordedBeat: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = RecordedSegment.protoMessageName + ".RecordedBeat"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 2: try { try decoder.decodeSingularUInt32Field(value: &self.beat) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.beat != 0 {
      try visitor.visitSingularUInt32Field(value: self.beat, fieldNumber: 2)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: RecordedSegment.RecordedBeat, rhs: RecordedSegment.RecordedBeat) -> Bool {
    if lhs.timestamp != rhs.timestamp {return false}
    if lhs.beat != rhs.beat {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
}

extension RecordedSegment.RecordedData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = RecordedSegment.protoMessageName + ".RecordedData"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "timestamp"),
    2: .same(proto: "midiData"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 1: try { try decoder.decodeSingularUInt64Field(value: &self.timestamp) }()
      case 2: try { try decoder.decodeSingularBytesField(value: &self.midiData) }()
      default: break
      }
    }
  }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if !self.midiData.isEmpty {
      try visitor.visitSingularBytesField(value: self.midiData, fieldNumber: 2)
    }
    try unknownFields.traverse(visitor: &visitor)
  }

  static func ==(lhs: RecordedSegment.RecordedData, rhs: RecordedSegment.RecordedData) -> Bool {
    if lhs.timestamp != rhs.timestamp {return false}
